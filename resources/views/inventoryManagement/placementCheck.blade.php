@extends('layout.app')
@section('headerTitle', 'PLACEMENT CHECK')
@section('content')
@section('title', 'PLACEMENT CHECK')
            ...
            <div class="report_title w-full h-[50px] justify-center items-center rounded-t-xl px-5 py-3 flex ">
                ...
                <div class="shine-bgBtn datePicker_header border rounded-xl">
                    <span class="flex  items-center justify-center px-5 gap-[5px]">
                        <x-datepicker id="placement_Datepicker" drops="down" class="whitespace-nowrap h-[30px] text-[13px]" />
...
<script type="module" src="/app/module/Inventory_Management/placementCheck.js"></script>