                    ...
                    <div class="tab-content bg-base-100 border-base-300 p-6">
                        <div class="flex w-full justify-between h-full flex-col">
                            <div class="flex w-full justify-start md:justify-end items-center">
                                <div
                                    class="flex w-full flex-col-reverse md:flex-row justify-between pb-5 gap-3 items-start lg:items-center h-full">
                                    <div
                        ...
                        <div class="flex w-full justify-between h-full flex-col">
                            <div class="flex w-full justify-start md:justify-end items-center">
                                <div
                                    class="flex w-full flex-col-reverse md:flex-row justify-between pb-5 gap-3 items-start lg:items-center h-full">
                                    <div
                                        class="flex rounded-2xl whitespace-nowrap gap-2 items-center font-medium justify-end">
                                        <button id="groupTransaction"
                                            class="btn h-[30px] sheenFilterBtn rounded-2xl text-[12px]">Group
                                            Transaction</button>
                                        <button class="btn rounded-2xl text-[12px] h-[30px] sheenFilterBtn"
                                            onclick="filter.showModal()">Filter</button>
                                    </div>
                                    <div class="flex w-full justify-start md:justify-end items-center">
                                        <div
                                            class="flex items-center border px-2 rounded-2xl w-[280px] sm:w-[550px] md:w-[300px]">
        ...
        <div class="modal-box p-0">
            ...
            <div class="flex flex-col gap-2 p-5">
                ...
                <div class="flex w-full box-shadow bg-base-200 rounded-xl gap-[80px] p-2 items-center">
                    ...
                    <x-datepicker id="TransactionDatePicker" class="flex w-full whitespace-nowrap justify-start text-black "
                        label="Click Here To Filter Date" />
                </div>
            </div>
                ...
                <form method="dialog ">
                    <div class="flex gap-2 w-full justify-end">
                        <form method="dialog" class="flex gap-3">
                            <button type="submit"
                                class="btn bg-gray-500 hover:bg-gray-600 text-white border-none">Close</button>
                        </form> <button class="btn">Proceed</button>
                    </div>
                </form>
            </div>
        </div>
            ...
            <div class="modal-box p-0 max-w-lg">
                ...
                <div class="flex flex-col">
                    <div class="flex items-center w-full justify-between px-5 py-4 border-b">
                        ...
                        <select id="stockRequest_salesman"
                            class="border justify-start rounded-lg px-3 py-2 text-sm text-gray-500 w-full">
                ...
                <div class="flex w-full justify-end p-5 gap-3 border-t">
                    ...
                    <button type="button" id="stockRequest_executeBtn"
                        class="btn bg-red-900 hover:bg-red-800 text-white border-none">Execute</button>
                </div>
            </div>
        </dialog>
                ...
                <div class="flex w-full flex-col">
                    ...
                    <div class="flex w-full gap-5 p-5 justify-end border-t">
                        <form method="dialog" class="flex gap-3">
                            <button type="submit"
                                class="btn bg-gray-500 hover:bg-gray-600 text-white border-none">Close</button>
                        </form> <button class="btn">Execute</button>
                    </div>
                </div>
            </div>
        </dialog>
