        ...
        <div class="modal-box p-0 max-w-2xl">
            ...
            <div class="flex flex-col gap-5 p-5">
                <div class="flex items-center justify-between">
                    <label for="filter_daysOfVisit" class="font-bold text-sm">Days of Visist:</label>
                    <select id="filter_daysOfVisit" class="border rounded-lg px-3 py-2 text-sm text-gray-500 w-60">
                ...
                <div class="flex items-center justify-between">
                    <label for="filter_weekVisited" class="font-bold text-sm">Week Visited:</label>
                    <select id="filter_weekVisited" class="border rounded-lg px-3 py-2 text-sm text-gray-500 w-60">
                        <option value="">Select</option>
                ...
                <div class="flex items-center justify-between">
                    <label for="filter_mcpStatus" class="font-bold text-sm">MCP Status:</label>
                    <select id="filter_mcpStatus" class="border rounded-lg px-3 py-2 text-sm text-gray-500 w-60">
                        <option value="">Select</option>
                ...
                <div class="flex items-center justify-between">
                    <label for="filter_activeFlag" class="font-bold text-sm">Active Flag:</label>
                    <select id="filter_activeFlag" class="border rounded-lg px-3 py-2 text-sm text-gray-500 w-60">
                        <option value="">Select</option>
    ...
    <dialog id="mcpLayoutModal" class="modal">
        <div class="modal-box p-0 max-w-2xl">
            ...
            <div class="flex flex-col gap-4 p-5">
                <div class="flex items-center justify-between">
                    <label for="update_frequency" class="font-bold text-sm w-32">Frequency</label>
                    <details class="dropdown  w-full max-w-sm">
                        <summary class="btn m-1 w-full">Choose Here</summary>
                        <ul id="freqDropdown" class="menu dropdown-content bg-base-100 rounded-box z-1 w-52 p-2 shadow-sm">
                ...
                <div class="flex items-center justify-between">
                    <label for="update_daysOfVisit" class="font-bold text-sm w-32">Days of Visit</label>
                    <details class="dropdown  w-full max-w-sm">
                        <summary class="btn m-1 w-full">Choose Here</summary>
                        <ul id="dayOfWeek" class="menu dropdown-content bg-base-100 rounded-box z-1 w-fit p-2 shadow-sm">
                ...
                <div class="flex items-center justify-between">
                    <label class="font-bold text-sm w-32">Days of Visit</label>
