                    ...
                    <div class="flex w-full h-full gap-5 flex-col">
                        <div class="flex flex-col gap-1">
                            ...
                            <input type="text" name="company_name" id="company_name" required
                                placeholder="e.g. Acme Corp" class="input input-bordered input-sm w-full rounded-lg h-[40px] custom-input" />
                        ...
                        <div class="flex flex-col gap-1">
                            ...
                            <input type="text" id="report_header" placeholder="Report header text"
                                class="input input-bordered input-sm w-full rounded-lg custom-input h-[40px]" />
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="flex w-full gap-2">
                    <div class="flex flex-col items-center gap-2 ">
                        ...
                        <input type="text" id="primaryColorHex" name="primaryColorHex" value="#3b82f6" 
                            class="text-xs bg-base-200 rounded-lg px-3 py-2 font-medium h-[40px] border  w-full" />
                    </div>
