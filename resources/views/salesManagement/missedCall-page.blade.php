            ...
            <div class="report_title w-full h-[50px] justify-center items-center rounded-t-xl px-5 py-3 flex ">
               ...
               <div class="shine-bgBtn datePicker_header border rounded-xl">
                    <span class="flex  items-center justify-center  px-5 gap-[5px]">
                        <x-datepicker id="Miss_Datepicker" drops="down" class="whitespace-nowrap  h-[30px] text-[13px]" />
            ...
            <div class="w-full items-center h-full bg-grey-500 flex flex-col px-5">
                <div class="flex items-center w-full h-[60px] py-3">
                    ...
                    <div class=" border h-[30px] items-center justify-center flex px-2 rounded-2xl sm:max-w-[500px]  ">
                        ...
                        <x-searchbar class="w-[250px]" tableId="#missedCallTable" />
                    </div>
                </div>
              <div class="w-full pb-5 overflow-x-auto rounded-2xl max-h-[calc(100vh_-_250px)] " id="DataTable">
