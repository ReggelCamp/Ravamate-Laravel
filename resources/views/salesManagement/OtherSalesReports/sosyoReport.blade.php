@extends('layout.app')
@section('headerTitle', 'FASTSOSYO TRANSACTIONS')
@section('content')
@section('title', 'FASTSOSYO TRANSACTIONS')
    ...
    <div class="flex w-full h-full pb-20 pt-5 px-3">
        <div class="card w-full h-full flex flex-col">
            <div class="report_title w-full h-[50px] justify-center items-center rounded-t-xl px-5 py-3 flex ">
                <x-salesReportHeader title="Fastsosyo Transactions" />
            </div>
            <div class="w-full items-center h-full flex-1 bg-grey-500 flex flex-col px-5">
                <div class="flex flex-col-reverse gap-3 md:flex-row items-center w-full min-h-[60px] py-3">
                    <div class="flex gap-5 w-full">
                        <div>
                            <button class="w-fit px-5 whitespace-nowrap border rounded-2xl h-[30px] text-[12px]">
                        ...
                        <div>
                            <x-exportDataTable :hidePrint="true" :hideCopy="true" label="Others" tableId="#strikeRateTable"
                                class=" w-fit px-5 sheenFilterBtn !whitespace-nowrap font-medium text-[12px]">

                                <li class="shine-bgExportBtn">
                                    <a href="#" id="viewStrikeDetails">
                                        <i class="fa-solid fa-eye"></i>
                                        Reload
                                    </a>
                                </li>
                                <li class="shine-bgExportBtn">
                                    <a href="/sosyoactivation" id="viewStrikeDetails">
                                        <i class="fa-solid fa-eye"></i>
                                        Activations
                                    </a>
                                </li>
                                <li class="shine-bgExportBtn">
                                    <a href="/sosyocalendar" id="viewStrikeDetails">
                                        <i class="fa-solid fa-eye"></i>
                                        Sosyo Calendar
                                    </a>
                                </li>
                    ...
                    <div class="flex w-full justify-start md:justify-end items-center">
                        <div class="flex items-center border px-2 rounded-2xl w-[280px] sm:w-[550px] md:w-[300px]">
                            ...
                            <x-searchbar tableId="#strikeRateTable" class="w-full h-[30px] font-medium customSearch"
                                id="strikesSearch" />
                        </div>
                    </div>
                </div>
...
<script type="module" src="/app/module/Sale_Management/OtherSalesReports/strikeRate.js"></script>