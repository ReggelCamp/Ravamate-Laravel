    ...
    <div class="flex w-full h-full pb-20 pt-5 px-3">
        <div class="card w-full h-full flex flex-col">
            <div class="report_title w-full h-[50px] justify-center items-center rounded-t-xl px-5 py-3 flex ">
                <x-salesReportHeader title="Range Monitoring" />
            </div>
            <div class="w-full items-center h-full flex-1 bg-grey-500 flex flex-col px-5">
                ...
                <div class="w-full flex flex-col gap-2">
                    <div class="w-full whitespace-nowrap flex-1 overflow-auto pb-5">
                        <x-datatable id="rangeMonitoringTable" />
                    </div>
                </div>
            </div>
        </div>
...
<script type="module" src="/app/module/Sale_Management/OtherSalesReports/rangeMonitoring.js"></script>
